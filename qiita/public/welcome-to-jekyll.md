...
GitHub Pagesで無料ホスティングができ、Gitでバージョン管理も可能です。デプロイも自動で行われるので、記事を書くことに集中できます。
...
HTML/CSS/JavaScriptを使って自由にカスタマイズできます。テーマやプラグインも豊富で、必要に応じて機能を追加できます。
...
新しい技術を学ぶ過程で得た知見や、つまずいたポイントとその解決方法を記録していきます。同じような課題に直面している方の参考になれば嬉しいです。

### 開発環境の構築

実際に使っている開発環境やツールの設定方法、便利なコマンドなどを共有します。WSL、Docker、VSCodeなどの環境構築についても書いていきたいと思います。
...
まずはこのブログ自体の構築過程を記事にしていく予定です。Jekyll + GitHub Pagesでのブログ立ち上げ方、カスタマイズの方法などを詳しく解説します。  
