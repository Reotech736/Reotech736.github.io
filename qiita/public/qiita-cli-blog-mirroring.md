...
そこで、Jekyllの`_posts/`を正本にして、[Qiita CLI](https://reotech736.com/terms/qiita-cli/)用Markdownを生成する仕組みを追加しました。mainブランチへマージした記事だけを[GitHub Actions](https://reotech736.com/terms/github-actions/)からQiitaへ投稿します。
...
![Qiita Previewのサイドバーに、生成した記事が未投稿として表示されている](https://reotech736.com/assets/images/posts/qiita-cli-blog-mirroring/qiita-preview-draft-list.png)

記事を選択すると、タイトル、タグ、本文、図をQiitaに近い表示で確認できます。

![Qiita Previewで「Jekyllブログの記事をQiita CLIで自動ミラーする」を表示している](https://reotech736.com/assets/images/posts/qiita-cli-blog-mirroring/qiita-preview-article.png)
...
この記事は[Reo's Tech Blogの同名記事](https://reotech736.com/2026/08/08/qiita-cli-blog-mirroring.html)にも掲載しています。
