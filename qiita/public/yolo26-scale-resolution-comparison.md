...
![YOLO26 n・s・mの320pxと640pxについて、person・car平均APとPC ORT推論p50の関係を示した散布図](https://reotech736.com/assets/images/posts/yolo26-scale-resolution-comparison/quality-latency-pareto.png)
...
![s・320、n・640、m・320の品質差とPC推論時間、ONNXサイズ、実行時メモリの増減を比較した図](https://reotech736.com/assets/images/posts/yolo26-scale-resolution-comparison/selection-knee.svg)
