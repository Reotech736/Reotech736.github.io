...
![YOLO26の6条件についてperson・car平均APとPC ORT推論p50を比較し、n・640とs・640を次の候補として示した散布図](/assets/images/posts/yolo26-scale-resolution-comparison/quality-latency-pareto-two-candidates.svg)
...
![n・640を軽量側、s・640を品質側として次のFP32・FP16・INT8比較へ残す判断図](/assets/images/posts/yolo26-scale-resolution-comparison/selection-knee.svg)
...
- INT8で[スループット](/terms/throughput/)が実際に上がるか
