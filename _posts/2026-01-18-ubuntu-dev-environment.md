...
新たにNucBoxK12を購入したので、これまで使っていたNucBoxG5をLinuxサーバに回すことにしました。WSLからおさらばして、ネイティブUbuntuで開発できる環境にします。ただ、せっかくのWindows 11 Proを消すのはもったいないので、デュアルブート環境を構築します。  
今回選んだOSは Ubuntu 24.04.3 LTS です。リリースから時間も経ち、そろそろ落ち着いてきた頃合いかなと思っています。  
