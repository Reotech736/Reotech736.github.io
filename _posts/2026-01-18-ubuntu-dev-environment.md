...
新たにNucBoxK12を購入したので、これまで使っていたNucBoxG5をLinuxサーバに回すことにしました。[WSL](/terms/wsl/)からおさらばして、ネイティブUbuntuで開発できる環境にします。ただ、せっかくのWindows 11 Proを消すのはもったいないので、[デュアルブート](/terms/dual-boot/)環境を構築します。今回選んだOSは Ubuntu 24.04.3 [LTS](/terms/long-term-support/) です。リリースから時間も経ち、そろそろ落ち着いてきた頃合いかなと思っています。
...
ドライブ暗号化機能の[BitLocker](/terms/bitlocker/)が有効だとトラブルになりやすいので、事前に無効化しました。
...
| 項目          | 設定       |
| ----------- | -------- |
| [Secure Boot](/terms/secure-boot/) | **OFF**  |
| SATA Mode   | **AHCI** |
| Boot Mode   | **[UEFI](/terms/uefi/)** |
| Fast Boot   | OFF      |
| VT-x / VT-d | ON       |
